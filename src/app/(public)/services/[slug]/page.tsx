...
const mockServices: Service[] = [
    ...
    description:
      'I will provide personalized tutoring for college-level students. With clear explanations and exam strategies, that will help you feel confident and prepared.',
  }
];
