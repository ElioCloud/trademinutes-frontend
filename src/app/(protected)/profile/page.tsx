            ...
            {editingCoverImage ? (
              ...
              <>
                {profile.CoverImageURL ? (
                  // When cover image is set, show the image with content overlay
                  <>
                    <Image 
                  ...
                  // When no cover image, show the Categories page banner design
                  <div className="w-full h-full bg-gradient-to-br from-amber-50 to-orange-50 relative">
                    {/* Background decorative shapes */}
                    <div className="absolute top-0 left-0 w-32 h-32 bg-yellow-300 rounded-full opacity-60"></div>
                    <div className="absolute bottom-0 right-0 w-48 h-48 bg-orange-200 rounded-full opacity-40"></div>
